# -*- coding: utf-8 -*-
"""
AI Müzik & Ses Prodüksiyon Stüdyosu — Demo
...
<div class="metric-card">
    ...
    <div class="label">{label}</div>
        ...
        with c_info:
            ...
            best = r["tone"]
            speed_map = {"enerjik":1.15,"kurumsal":0.92,"dramatik":0.85,"samimi":1.0,"lüks":0.88}
            ducking_str = "%30 (önerilen)" if best in ["kurumsal","dramatik","lüks"] else "%40 (dinamik)"
            st.markdown(f"""
| Ayar | Öneri |
|------|-------|
| TTS Tonu | **{best.upper()}** |
| Konuşma Hızı | **{speed_map[best]}x** |
